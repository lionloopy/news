          ...
          <StContent>
            ...
            <StContents>
              ...
              <StA>
                ...
                사무직으로 취직을 하게 되었습니다. 전 회사의 교육 관련 과목 중
                웹퍼블리셔 양성 과정이 있었고, 회사의 지원으로 무료로 수업을
                듣게 되며 개발을 접하게 되었습니다.
              </StA>
              ...
              <StA>
                ...
                너무 신기했습니다. 그렇게 처음부터 저는 코딩의 세계에 푹
                빠져버렸습니다.
              </StA>
              <StQ>그렇다면 왜 프론트엔드 개발을 선택하셨나요?</StQ>
              <StA>
                앞서 말씀드렸다시피, 저는 제가 만든 코드가 바로바로 눈에 보이는
                것이 재밌었습니다. 더 나아가, 내가 이러한 기능을 만들어 유저가
                사용하게 된다면? 나의 코드로 사람들의 삶에 더 편리함을 줄 수
                있다면? 이라는 생각을 가지게 되었고, 그 생각이 프론트엔드
                개발자의 꿈으로 저를 닿게 해 주었습니다.
              </StA>
              <StQ>개발을 배우면서 힘든적은 없었나요?</StQ>
              <StA>
                처음엔 맨땅에 헤딩을 하며 막막했을 때도 있었습니다. 하지만
                코딩이 너무 재밌었고, 빠른 습득력으로 하나하나 놓치지 않고 모두
                제것으로 만들려고 노력했습니다. 그랬더니 부트캠프 진행 중
                제로베이스에서 과제 제출을 1등으로 하는 사람이 되었고, div도
                모르던 제가 코드를 40,000줄을 짜는 프론트엔드 리더가 되어
                있었습니다.
              </StA>
              <StQ>앞으로의 계획이 있다면?</StQ>
              <StA>
                저는 앞으로 성실한 개발자가 되는 것이 꿈입니다. 성실함은 항상
                결과물로 나타나더라고요?(웃음) 또한 즐기는 자를 이길 수는 없다고
                생각합니다. 코딩이 즐겁고, 매 순간 성실한 모습으로 성장하는 그런
                개발자가 되고 싶습니다.
              </StA>
            </StContents>
          </StContent>
